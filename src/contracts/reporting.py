...
class DailyReportViewModel:
    ...
    info_summary: dict[str, object] = field(default_factory=dict)
    external_signals: dict[str, object] = field(default_factory=dict)
    mainlines: list[dict[str, object]] = field(default_factory=list)
    theme_episodes: list[dict[str, object]] = field(default_factory=list)
    leader_candidates: list[dict[str, object]] = field(default_factory=list)
    holding_role_changes: list[dict[str, object]] = field(default_factory=list)
    execution_plans: list[dict[str, object]] = field(default_factory=list)
    monitor_recommendations: list[dict[str, object]] = field(default_factory=list)
...
class ResearchReportViewModel:
    ...
    theme_lifecycle_summary: dict[str, object] = field(default_factory=dict)
    role_distribution_summary: dict[str, object] = field(default_factory=dict)
    exit_contribution_summary: dict[str, object] = field(default_factory=dict)
    leader_summary: dict[str, object] = field(default_factory=dict)
