...
def write_v2_ranking_research_report(out_path: str | Path, result: V2RankingResearchResult) -> Path:
    ...
    lines = [
        ...
        f"- confirmed_precision_at_1: `{_fmt_pct(leader_eval.get('confirmed_precision_at_1', 0.0))}`",
        f"- possible_recall_at_k: `{_fmt_pct(leader_eval.get('possible_recall_at_k', 0.0))}`",
        f"- not_leader_avoid_rate: `{_fmt_pct(leader_eval.get('not_leader_avoid_rate', 0.0))}`",
        ...
        f"- leader_eval_confirmed_precision_at_1: `{_fmt_pct(signal.get('leader_eval_confirmed_precision_at_1', 0.0))}`",
        f"- leader_eval_possible_recall_at_k: `{_fmt_pct(signal.get('leader_eval_possible_recall_at_k', 0.0))}`",
        f"- leader_eval_not_leader_avoid_rate: `{_fmt_pct(signal.get('leader_eval_not_leader_avoid_rate', 0.0))}`",
        ...
        f"- leader_eval_filter_possible_recall: `{_fmt_pct(signal.get('leader_eval_filter_possible_recall', 0.0))}`",
        f"- leader_eval_filter_confirmed_recall: `{_fmt_pct(signal.get('leader_eval_filter_confirmed_recall', 0.0))}`",
        f"- leader_eval_filter_not_leader_rate: `{_fmt_pct(signal.get('leader_eval_filter_not_leader_rate', 0.0))}`",
        ...
        f"- exit_eval_path_corr: `{_fmt_num(signal.get('exit_eval_path_corr', 0.0))}`",
        ...
        f"- exit_eval_label_accuracy: `{_fmt_pct(signal.get('exit_eval_label_accuracy', 0.0))}`",
        f"- exit_eval_keep_precision: `{_fmt_pct(signal.get('exit_eval_keep_precision', 0.0))}`",
        f"- exit_eval_watch_or_worse_recall: `{_fmt_pct(signal.get('exit_eval_watch_or_worse_recall', 0.0))}`",
        f"- exit_eval_reduce_or_worse_recall: `{_fmt_pct(signal.get('exit_eval_reduce_or_worse_recall', 0.0))}`",
        f"- exit_eval_exit_fast_recall: `{_fmt_pct(signal.get('exit_eval_exit_fast_recall', 0.0))}`",
        "",
        "## Label Coverage",
        "",
        ...
        f"- full leader tri-labels: `confirmed={result.full_training_label_manifest.get('leader_confirmed_count', 0)}` | `possible={result.full_training_label_manifest.get('leader_possible_count', 0)}` | `not={result.full_training_label_manifest.get('leader_not_count', 0)}`",
        ...
        f"- fit leader tri-labels: `confirmed={result.fit_training_label_manifest.get('leader_confirmed_count', 0)}` | `possible={result.fit_training_label_manifest.get('leader_possible_count', 0)}` | `not={result.fit_training_label_manifest.get('leader_not_count', 0)}`",
        ...
        f"- evaluation leader tri-labels: `confirmed={result.evaluation_training_label_manifest.get('leader_confirmed_count', 0)}` | `possible={result.evaluation_training_label_manifest.get('leader_possible_count', 0)}` | `not={result.evaluation_training_label_manifest.get('leader_not_count', 0)}`",
        "",
...
def write_v2_ranking_research_dashboard(out_path: str | Path, result: V2RankingResearchResult) -> Path:
    ...
    cards = [
        ...
        ("Confirmed Precision@1", _fmt_pct(leader_eval.get("confirmed_precision_at_1", 0.0))),
        ("Possible Recall@K", _fmt_pct(leader_eval.get("possible_recall_at_k", 0.0))),
        ("Not-Leader Avoid", _fmt_pct(leader_eval.get("not_leader_avoid_rate", 0.0))),
        ...
        ("Leader Top1 Hit", _fmt_pct(signal.get("leader_eval_confirmed_precision_at_1", 0.0))),
        ("Leader Filter Possible", _fmt_pct(signal.get("leader_eval_filter_possible_recall", 0.0))),
        ("Exit Path Corr", _fmt_num(signal.get("exit_eval_path_corr", 0.0))),
    ]
    card_html = "".join(
        [
            (
