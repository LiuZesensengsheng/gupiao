...
def publish_research_artifacts(
    *,
    ...
    if publish_forecast_models and frozen_daily_state:
        frozen_composite = dependencies.decode_composite_state_fn(frozen_daily_state.get("composite_state"))
        if frozen_composite is not None:
            ...
            frozen_daily_state["composite_state"] = dependencies.serialize_composite_state_fn(frozen_composite)
    ...
    if update_latest and release_gate_passed and allow_default_latest_update:
        ...
        dependencies.emit_progress_fn("publish", "门禁未通过，本次不更新 latest policy/manifest")
