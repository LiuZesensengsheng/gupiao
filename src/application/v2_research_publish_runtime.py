    ...
    dataset_manifest = add_artifact_metadata(
        {
            ...
            "publish_timestamp_count": int(info_artifacts.info_manifest.get("publish_timestamp_count", 0)),
            "publish_timestamp_coverage_ratio": float(info_artifacts.info_manifest.get("publish_timestamp_coverage_ratio", 0.0)),
